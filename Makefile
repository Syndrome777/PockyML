...
VPATH=src:src/ANN:src/NB:src/Kmeans:src/KNN:src/PCA:test

CC=g++

all:ann_test nb_test kmeans_test knn_test pca_test
.PHONY:all
...
.PHONY:clean
clean:
	-rm *.o ann_test nb_test kmeans_test knn_test pca_test
